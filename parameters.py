...
class Parameters:
    def __init__(self):
        ...
        parser.add_argument('-freq_vcb', type=int, default=1, help='what less than that value will be deleted')
        parser.add_argument('-vcb_size', type=int, default=30000, help='what high than that value will be deleted')
        parser.add_argument('-save_dir', type=str, default='', help='train.txt, dev.txt, test.txt vocab.txt those who are processed will be saved here')
        ...
        parser.add_argument('-gpu_device', type=int, default=0, help='decide which gpu device will be selected, default device 0')
        ...
        train
        '''
        parser.add_argument('-pre_embed', type=bool, default=False, help='If using prepared embedding, select True, default False')
        ...
        parser.add_argument('-data_dir', type=str, default='', help='code will read train [dev test vocab] file here ')
        parser.add_argument('-lr', type=float, default=0.1, help='learning rate, recommand: sgd:0.1, adam:0.001')
